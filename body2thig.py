...
# f_rpy_z = R_rpy @ np.array([0, 0, 1])
# f_rpy_y = R_rpy @ np.array([0, 1, 0])
...
# fz_j1_j2_j3 = lambda j1,j2,j3: R_lHip_j1_j2_j3(j1,j2,j3) @ np.array([0, 0, 1])
# fy_j1_j2_j3 = lambda j1,j2,j3: R_lHip_j1_j2_j3(j1,j2,j3) @ np.array([0, 1, 0])
...
#     step = np.array([rand.random()-0.5, rand.random()-0.5, rand.random()-0.5])*fact
#     print(f"{step = }")
